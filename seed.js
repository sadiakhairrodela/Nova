/**
 * ddodle PROJECT - Database Seed Script
 * Populates the database with sample data for showcase
 * 
 * Usage: node seed.js
...
const pool = mysql.createPool({
  ...
  database: process.env.DB_NAME || 'ddodle_project',
...
async function seed() {
  ...
  try {
    ...
    await connection.execute('DELETE FROM babies');
    ...
    console.log(`✅ Inserted ${babiesData.length} babies\n`);

    // ============================================================
    // Insert Videos - Baby 1: Liam Johnson
    // ============================================================
    ...
    // ============================================================
    console.log('📝 Inserting video reviews...');
    ...
    console.log(`✅ Inserted ${reviewsData.length} video reviews\n`);
    ...
    console.log('======================================');
    console.log('📈 Summary:');
    console.log('  • Users: 5 (1 admin + 4 caregivers + 1 senior admin)');
    console.log('  • Babies: 6');
    console.log('  • Videos: 25');
    console.log('    - Approved: 13');
    console.log('    - Under Review: 5');
